...
#   Three RFR for each segment with hyperparameters
rf_model_1_7 = RandomForestRegressor(**params, random_state=42)
rf_model_8_23 = RandomForestRegressor(**params, random_state=42)
rf_model_24_plus = RandomForestRegressor(**params, random_state=42)

rf_model_1_7.fit(X_train_1_7, y_train_1_7)
rf_model_8_23.fit(X_train_8_23, y_train_8_23)
rf_model_24_plus.fit(X_train_24_plus, y_train_24_plus)

#   Make Predictions on training sets

y_pred_1_7 = rf_model_1_7.predict(X_test_1_7)
y_pred_8_23 = rf_model_8_23.predict(X_test_8_23)
y_pred_24_plus = rf_model_24_plus.predict(X_test_24_plus)

# Calculate regression metrics for each segment
...
# Exclude 10 examples from training
...
# Predict length of stay for excluded examples
excluded_data = data.loc[exclude_indices].drop(columns=["Length of Stay"])
y_excluded_pred_1_7 = rf_model_1_7.predict(excluded_data)
y_excluded_pred_8_23 = rf_model_8_23.predict(excluded_data)
y_excluded_pred_24_plus = rf_model_24_plus.predict(excluded_data)

# Print actual vs. predicted length of stay for excluded examples
